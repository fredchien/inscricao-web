...
import { faLinkedin, faSquareInstagram, faSquareTumblr, faSquareFacebook  } from '@fortawesome/free-brands-svg-icons';

import TriangleTwo from "../../assets/triangle-blue.png";
import TriangleOne from "../../assets/triangle-orange.png";
